...
const VarType_Type VarType_Type_Type_MAX = VarType_Type_PSTRING;
...
class OpDesc_Attr : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:paddle.framework.proto.OpDesc.Attr) */ {
 ...
 private:
  ...
  inline void set_has_float64();
  inline void clear_has_float64();
...
class OpProto_Var : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:paddle.framework.proto.OpProto.Var) */ {
 ...
 private:
  ...
  inline void set_has_quant();
  inline void clear_has_quant();
...
class OpProto_Attr : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:paddle.framework.proto.OpProto.Attr) */ {
 ...
 private:
  ...
  inline void set_has_quant();
  inline void clear_has_quant();
  inline void set_has_support_tensor();
  inline void clear_has_support_tensor();
...
class VarType : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:paddle.framework.proto.VarType) */ {
 ...
 private:
  ...
  inline void set_has_strings();
  inline void clear_has_strings();
  inline void set_has_vocab();
  inline void clear_has_vocab();
...
class VarDesc_Attr : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:paddle.framework.proto.VarDesc.Attr) */ {
 public:
  ...
  static const VarDesc_Attr* internal_default_instance();

  void Swap(VarDesc_Attr* other);

  // implements Message ----------------------------------------------

  inline VarDesc_Attr* New() const { return New(NULL); }

  VarDesc_Attr* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  ...
  void UnsafeMergeFrom(const VarDesc_Attr& from);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
...
extern ::google::protobuf::internal::ExplicitlyConstructed<VarDesc_Attr> VarDesc_Attr_default_instance_;
...
class VarDesc : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:paddle.framework.proto.VarDesc) */ {
 ...
 private:
  ...
  inline void set_has_is_parameter();
  inline void clear_has_is_parameter();
  inline void set_has_stop_gradient();
  inline void clear_has_stop_gradient();
