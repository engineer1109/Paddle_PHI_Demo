...
PADDLE_API Tensor sparse_coo_tensor(const Tensor& values, const Tensor& indices, const IntArray& dense_shape);
...
PADDLE_API Tensor addmm(const Tensor& input, const Tensor& x, const Tensor& y, float alpha = 1.0, float beta = 1.0);
